...
public class OptionScreen extends Screen {
	...
	protected final void update() {
		...
		if (this.selectionCooldown.checkFinished()
			...
			if (inputManager.isKeyDown(KeyEvent.VK_DOWN) || inputManager.isKeyDown(KeyEvent.VK_S)) {downSpeedItem();this.chk_setting = true;this.selectionCooldown.reset();
			}
			if (inputManager.isKeyDown(KeyEvent.VK_LEFT) || inputManager.isKeyDown(KeyEvent.VK_A)) {if (!this.chk_setting) previousSolItem();
				else
					previousSpeedItem();
				this.selectionCooldown.reset();
			}
